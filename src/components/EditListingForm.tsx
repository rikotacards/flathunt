...
export const EditListingForm: React.FC<IListing & { onClose: () => void }> = (
  props
) => {
  ...
  const onUpdate = async () => {
    ...
    await updateListing(props.listingId, {
      ...form,
      price: parseInt(form.price),
      fileNames: props.images,
    });
    // await addListing()
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        <Button sx={{ m: 1 }} variant="contained" onClick={onUpdate}>
          Update
        </Button>
      </Box>
    </DndProvider>
