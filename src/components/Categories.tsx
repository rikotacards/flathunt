...
const categories: {
  ...
  { label: "Balcony", fieldName: "hasBalcony", icon: <DeckIcon /> },
  { label: "pet friendly", fieldName: "hasPetFriendly", icon: <PetsIcon /> },
  {
    label: "No Fees",
  ...
  { label: "Walk ups", fieldName: "hasWalkup", icon: <StairsIcon /> },
];
